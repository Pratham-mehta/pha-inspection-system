...
class ResponseService {
    ...
    // Alias for createResponse
    func createResponse(soNumber: String, request: CreateResponseRequest) async throws -> InspectionResponseDTO {
        return try await saveResponse(soNumber: soNumber, request: request)
    }
